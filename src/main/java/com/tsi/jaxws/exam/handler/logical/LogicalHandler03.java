 ...
 * @author Даниил
 */
public class LogicalHandler03 implements LogicalHandler<LogicalMessageContext> {
     ...
     * Internal logger
     */
    private final Logger logger = LoggerFactory.getLogger(LogicalHandler03.class);
     ...
     */
    public LogicalHandler03() throws JAXBException {
    ...
    public boolean handleMessage(LogicalMessageContext context) {
        ...
        if (!isRequest) {
            ...
            customer.setLastname(customer.getLastname() + " logical-handler-03");
