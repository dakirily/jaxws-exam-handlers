 ...
 * @author Даниил
 */
public class LogicalHandler01 implements LogicalHandler<LogicalMessageContext> {
     ...
     * Internal logger
     */
    private final Logger logger = LoggerFactory.getLogger(LogicalHandler01.class);
     ...
     */
    public LogicalHandler01() throws JAXBException {
    ...
    public boolean handleMessage(LogicalMessageContext context) {
        ...
        if (!isRequest) {
            ...
            customer.setLastname(customer.getLastname() + " logical-handler-01");
