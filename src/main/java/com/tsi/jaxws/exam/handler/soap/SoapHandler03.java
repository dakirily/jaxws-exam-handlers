 ...
 * @author Даниил
 */
public class SoapHandler03 implements SOAPHandler<SOAPMessageContext> {

    /**
     * Internal logger
     */
    private final Logger logger = LoggerFactory.getLogger(SoapHandler03.class);
    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        try {
            ...
            // add header
            if (isRequest) {
                header.addHeaderElement(new QName("http://com.tsi.jaxws.exam", "request-soap-header-03"));
            } else {
                header.addHeaderElement(new QName("http://com.tsi.jaxws.exam", "response-soap-header-03"));
            }
