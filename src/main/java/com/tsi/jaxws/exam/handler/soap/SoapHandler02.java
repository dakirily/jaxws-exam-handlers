 ...
 * @author Даниил
 */
public class SoapHandler02 implements SOAPHandler<SOAPMessageContext> {

    /**
     * Internal logger
     */
    private final Logger logger = LoggerFactory.getLogger(SoapHandler02.class);
    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        try {
            ...
            // add header
            if (isRequest) {
                header.addHeaderElement(new QName("http://com.tsi.jaxws.exam", "request-soap-header-02"));
            } else {
                header.addHeaderElement(new QName("http://com.tsi.jaxws.exam", "response-soap-header-02"));
            }
